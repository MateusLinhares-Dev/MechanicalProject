...
SECRET_KEY = 'django-insecure-zw0@2d_s)3f28#rysu8e9z2rejr@0^s(2szbqx%pzti-vm@2rm'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Mechanical Manager",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Mechanical Manager",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Mechanical Manager",
    ...
    "welcome_sign": "Bem-vindo ao Mechanical Manager",

    # Copyright on the footer
    "copyright": "Mateus Linhares LTDA.",
    ...
    "icons": {
        ...
        "products.ProductType":"fa-solid fa-tags",
        "products.Product":"fa-solid fa-oil-can",
